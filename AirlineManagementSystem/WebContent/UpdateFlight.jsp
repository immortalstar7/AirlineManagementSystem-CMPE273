...
<!-- Navigation Ends -->
 <div class="container">
  <form class="form-signin" method="post" action=UpdateFlightServlet >
  		<% if(request!=null && request.getAttribute("updatestatus")!=null) { %>
   		<span  style="font-size: 15px; " class="label label-info"><%=request.getAttribute("updatestatus").toString() %></span>
   		<% } %>
   		<br><br>
        <span  style="font-size: 25px; margin-left:50px;" class="label label-primary">Update Flight</span>
        <br>
        
		<br><br><br>
		
         <input type="text" name="updateflightNumber" class="form-control" placeholder="Flight Number" required autofocus pattern="[A-Za-z]{3}[0-9]{5}" />
        <br>
         <input type="text" id="currentflyingDate"  name="currentflyingDate" required="required" class="form-control" placeholder="Current Flight Scheduled Date"/>
         <br>
          <input type="text" id="updateflyingDate" name="updateflyingDate" required="required" class="form-control" placeholder="New Flight Date"/>
          <br>
          <input type="text" name="updatesource" pattern="[A-Za-z ]{2,30}" class="form-control" placeholder="Source">
          <br>
          <input type="text" name="updatedest" pattern="[A-Za-z\ ]{2,30}" class="form-control" placeholder="Destination">
       <br><br>
        <button class="btn btn-lg btn-primary btn-block" type="submit">Update Flight</button>
