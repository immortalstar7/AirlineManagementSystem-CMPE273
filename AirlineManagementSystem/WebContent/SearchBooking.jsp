 ...
 <div class="container">
  <form class="form-signin" method="post" action=SearchServlet >
  		<% if(request!=null && request.getAttribute("status")!=null) { %>
   		...
   		<% } %>
   		<br><br>
        <span  style="font-size: 25px; margin-left:50px;" class="label label-primary">Search Bookings</span>
        <br>        
		<br>
         <input type="text" name="flightNumber" class="form-control" placeholder="Flight Number" required autofocus pattern="[0-9A-Za-z-\\ ]{2,40}" title="No special characters and length should be greater than 2"/>
        <br>
