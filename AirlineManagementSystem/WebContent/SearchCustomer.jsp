...
<!-- Navigation Ends -->
 ...
 <div class="container">
  <form class="form-signin" method="post" action=SearchServlet>
   		...
   		<br><br>
        <span  style="font-size: 25px; margin-left:50px;" class="label label-primary">Search Customer</span>
        <table>
        	<tr>
        	...
        	<tr>
        		...
        		<td> <input type="text" id="nationality" name="nationality" class="form-control" placeholder="Nationality"  pattern="[A-Za-z]+" title="Please Enter only characters"/></td>
        	</tr>
        	<tr>
        		<td><input type="text" id="passport_no" name="passport_no" class="form-control" placeholder="Passport No"  pattern="[A-Za-z0-9]+" title="Please Enter characters or numbers only"/></td>
        	</tr>
        </table>
